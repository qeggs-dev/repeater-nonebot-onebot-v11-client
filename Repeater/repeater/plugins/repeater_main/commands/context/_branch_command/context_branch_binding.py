...
context_branch_binding = on_command("contextBranchBinding", aliases={"cbc", "context_branch_binding", "Context_Branch_Binding", "ContextBranchBinding"}, rule=to_me(), block=True)
